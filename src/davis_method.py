...
import src.utility_spectrogram as metrics
...
def ebvmSoundfromVideo(video_frames, audiosavepath, nscalesin, norientationsin, framerate):
    signal = vmSoundFromVideo(video_frames, nscalesin, norientationsin, framerate)
    sf.write(audiosavepath, signal, framerate)
